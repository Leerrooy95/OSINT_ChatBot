# Developer Profile: Austin Smith (Leerrooy95)

**Purpose**: Provides context about the repository owner for AI assistants referencing this Knowledge Base. This is the developer's GitHub Profile README, included so The Speaker and other AI tools understand who built this project, their background, and their capabilities.
...
**[🌐 Portfolio →](https://leerrooy95.github.io)** · **[📊 Live Dashboard →](https://regulatedfriction.streamlit.app)** · **[📜 Bill Translator →](https://bill-translator.onrender.com/)**

---

### 📌 Featured Projects

**[The Regulated Friction Project](https://github.com/Leerrooy95/The_Regulated_Friction_Project)** — Automated intelligence pipeline tracking temporal correlations between geopolitical friction events and institutional capital flows. Processed 8 years of data across 66 verified event pairs. Live dashboard fed by multi-agent LLM extraction (Scrapy → Zyte → Llama 17B → Perplexity Sonar Pro → Claude).
...
**[AI Manipulation Case Study](https://github.com/Leerrooy95/AI-Manipulation-OSINT-Case-Study)** — Quantitative documentation of a 207:1 keyword-frequency disparity across AI platforms with cross-platform verification. Full raw data and methodology published for independent verification.

**[Sovereign Capital Audit](https://github.com/Leerrooy95/Sovereign-Capital-Audit)** — Mapping structural dependencies of the US Defense Industrial Base on Gulf Sovereign Wealth (Mubadala/PIF) and East Asian industry. Tracks capital flows, supply chain vulnerabilities, and national security implications.
...
**[The Regulated Friction Project](https://github.com/Leerrooy95/The_Regulated_Friction_Project)** is where methodology caught up with ambition — automated scraping, statistical validation, reproducible findings, and a live intelligence dashboard fed by LLM extraction.
...
- **Automated OSINT pipelines** — multi-agent LLM extraction, Federal Register scrapers, 13F tracking, EO spiders
- **Temporal correlation frameworks** — lag analysis, permutation testing, Granger causality, convergence modeling
- **Live dashboards** — Streamlit + Plotly with automated data feeds
